...
extern void box_rtitle(bool set_it, short unr, char *rtitle);
...
extern void yapp_responses(short unr, char *info, int32_t infosize);
extern void yapp_input(short unr, char *info, int32_t infosize);
extern bool read_file(bool delete_afterwards, short unr, char *eingabe);
extern bool read_filepart(short unr);
extern void abort_fileread(short unr);
extern void read_file_immediately(bool delete_afterwards, short unr, char *eingabe);
...
extern void answer_sysrequest(short unr, bool MD2, bool MD5);
...
extern void set_password(short unr, bool superv, char *eingabe);
extern void import_pw(short unr, char *eingabe);
extern void change_unprotomode(short unr, char *eingabe);
extern void change_md2sf(short unr, char *eingabe, bool MD5);
...
extern bool valid_language(char *lan);
...
extern void show_version(short unr, bool extended);
...
extern void search_bull(short unr, char *w, bool kill, bool add);
extern void set_talk_mode(short unr, char *w);
extern void end_talk_mode(short unr, bool prompt);
extern void talk_line(short unr, char *eingabe);
extern void msgwuser(short unr, bool immediate, char *s, bool cr);
extern void send_msg(short unr, char *w, char *eingabe);
extern void reset_to_term(short unr, bool to_sat, bool to_node);
extern bool open_shell(short unr, bool transparent);
extern void call_runprg(bool extern_, short unr, char *fname,
			char *rkommando, bool full_gem, char *add_environment);
extern void set_comp_mode(short unr, char *w);
extern void stelle_uhr(char *eingabe, bool datum);
...
extern bool is_german(char *w);
extern bool for_german_readers(char *call1, char *call2, char *mbx);
